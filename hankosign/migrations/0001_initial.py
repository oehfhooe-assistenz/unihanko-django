...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Optional: e.g. WIREF, CHAIR …",
                        max_length=32,
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="This action may be performed multiple times on the same object.",
                        verbose_name="Repeatable",
                    ),
                ),
                (
                    "require_distinct_signer",
                    models.BooleanField(
                        default=False,
                        help_text="The same person cannot perform multiple gated stages on the same object.",
                        verbose_name="Require distinct signer",
                    ),
                ),
                (
                    "scope",
                    models.ForeignKey(
                        ...
                        related_name="hankosign_actions",
                        to="contenttypes.contenttype",
                        verbose_name="Scope (model)",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_verified",
                    models.BooleanField(
                        default=False, verbose_name="Verified (specimen on file)"
                    ),
                ),
                (
                    "name_override",
                    models.CharField(
                        blank=True,
                        max_length=160,
                        verbose_name="Printed name (override)",
                    ),
                ),
                (
                    "base_key",
                    models.CharField(
                        default=hankosign.models._default_base_key,
                        editable=False,
                        max_length=64,
                        verbose_name="Signer secret",
                    ),
                ),
                (
                    "pdf_specimen",
                    models.TextField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Signature specimen (PDF)",
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="hankosign_policies",
                        to="people.role",
                        verbose_name="Role",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to="signatures/specimen/%Y/%m/",
                        verbose_name="Signature specimen (PDF)",
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            model_name="action",
            index=models.Index(
                fields=["scope", "verb", "stage"], name="hankosign_a_scope_i_8f3fe8_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="policy",
            index=models.Index(
                fields=["role", "action"], name="hankosign_p_role_id_9a24ca_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="policy",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="hankosign_s_content_9bd217_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="signature",
            index=models.Index(
                fields=["verb", "stage"], name="hankosign_s_verb_4ce5e2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="signature",
            index=models.Index(
                ...
                name="hankosign_s_content_d55459_idx",
            ),
        ),
        migrations.AddConstraint(
            model_name="signature",
            constraint=models.UniqueConstraint(
                condition=models.Q(("is_repeatable", False)),
                fields=("content_type", "object_id", "verb", "stage"),
